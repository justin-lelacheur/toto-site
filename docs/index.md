...
<div style="max-width: 650px; margin: 100px auto 60px auto; padding: 0 16px; font-family: 'IBM Plex Sans', sans-serif; text-align: center; display: block; clear: both;">
  ...
  <!-- Minimal Icon Emblem Layer -->
  <div style="font-size: 2.25rem; margin-bottom: 32px; color: #6B2D38; font-family: 'IBM Plex Mono', monospace; font-weight: 500;">▲</div>

  <!-- Main Zensical-Style Header Title Block -->
  <h1 style="font-size: 3rem; font-weight: 300; line-height: 1.15; color: #111111; letter-spacing: -0.03em; margin: 0 0 24px 0; border: none; padding: 0;">
    Adaptive systems for evolving ideas.
  </h1>

  <!-- Zensical Core Sub-headline Copy Description -->
  <p style="font-size: 1.15rem; line-height: 1.65; color: #555555; font-weight: 300; margin: 0 auto 48px auto; max-width: 520px; border: none; padding: 0;">
    toto builds scalable, AI-native enterprise operating systems—from decentralized state graphs to serverless private microcloud meshes.
  </p>
